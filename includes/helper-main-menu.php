				 ...
				 $output .= "<div class='container av-logo-container'>";
					...
					$output .= "<div class='inner-container'>";
						...
						*/
						...
						if(!empty($post->ID)){
							if($post->ID=="859" or $post->ID=="2081" or $post->ID=="2080" or $post->ID=="2084" or $post->ID=="2090" or $post->ID=="2087"){
							$output .= "<div class='intel-family'><div class='intel-family-logo'></div></div>";
							}
						}
